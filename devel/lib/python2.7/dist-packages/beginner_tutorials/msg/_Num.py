...
class Num(genpy.Message):
  _md5sum = "ead398b639f1a91464490f62ba46732a"
...
string frame_id
"""
  __slots__ = ['header','first_name','last_name','counter']
  _slot_types = ['std_msgs/Header','string','string','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,first_name,last_name,counter
